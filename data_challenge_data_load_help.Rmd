...
Let's make a new categorical variable based on "ALLGRADEX", where we collapse into Elementary, Middle, High school, College. 
...
```{r}
dat_small <- dat_small %>% select(-ALLGRADEX)
```
...
counts <- table(dat_new$SEENJOY, dat_new$gradelevel)
mosaicplot(counts, 
           xlab = "Enjoys School", 
           ylab = "Grades",
